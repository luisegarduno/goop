...
- You can use your handy dandy `mcp__serena` server to search through the codebase and the memories indexed by Serena. If you get any errors using Serena, retry with different Serena tools.
